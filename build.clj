(ns build
  "Build script for canonical-edn - distribute to Clojars
...
(defn jar [_]
  ...
  (b/write-pom {:class-dir class-dir
                ...
                :basis @basis
                :src-dirs ["src"]
                :pom-data [[:description "Canonical EDN — deterministic serialization of EDN values to UTF-8 bytes"]
                           [:url "https://github.com/franks42/canonical-edn"]
                           [:licenses
                            [:license
                             [:name "EPL-2.0"]
                           ...
                           [:scm
                            [:url "https://github.com/franks42/canonical-edn"]
                            [:connection "scm:git:https://github.com/franks42/canonical-edn.git"]
                            [:developerConnection "scm:git:ssh://git@github.com/franks42/canonical-edn.git"]
                            [:tag (str "v" version)]]]})
